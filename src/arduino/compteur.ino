...
GroveTwoRGBLedMatrixClass ecran1(GROVE_TWO_RGB_LED_MATRIX_DEF_I2C_ADDR, 1), ecran2(GROVE_TWO_RGB_LED_MATRIX_DEF_I2C_ADDR+1, 1); // Déclaration de l'objet qui permet d'interagir avec les matrices
